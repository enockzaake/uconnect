...
const initialData: StudentProfile = {
  id: 1,
  user_id: 1,
  title: "Mr",
  first_name: "John",
        ...
        return (
          <Card>
            <CardContent className="space-y-4 pt-6">
              ...
              <Button onClick={() => handleUpdate("personal")}>
        ...
        return (
          <Card>
            <CardContent className="space-y-4 pt-6">
              ...
              <Button onClick={() => handleUpdate("academic")}>
        ...
        return (
          <Card>
            <CardContent className="space-y-4 pt-6">
              ...
              <Button onClick={() => handleUpdate("additional")}>
        ...
        return (
          <Card>
            <CardContent className="space-y-4 pt-6">
              ...
              <Button onClick={() => handleUpdate("employment")}>
        ...
        return (
          <Card>
            <CardContent className="space-y-4 pt-6">
              ...
              <Button onClick={() => handleUpdate("referees")}>
